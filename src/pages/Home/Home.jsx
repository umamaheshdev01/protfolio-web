      ...
      <div className="page home">
        ...
        <section ref={stickyTitlesRef} className="sticky-titles">
          ...
          <div className="sticky-titles-footer">
            <p className="primary sm">Building for the Web</p>
            <p className="primary sm">Open to Collaboration</p>
          </div>
          <h2 ref={(el) => (titlesRef.current[0] = el)}>
            I craft websites that blend creativity with functionality.
          </h2>
          <h2 ref={(el) => (titlesRef.current[1] = el)}>
            Each project is driven by clean code, thoughtful design, and innovation.
          </h2>
          <h2 ref={(el) => (titlesRef.current[2] = el)}>
            This portfolio is a showcase of the digital experiences I create.
          </h2>
        </section>
